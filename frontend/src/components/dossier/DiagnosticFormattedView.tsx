    ...
    <>
      ...
      <div
        className={cn(
          ...
          '[&_.diag-visage-op-title]:mt-4 [&_.diag-visage-op-title:first-child]:mt-0',
          '[&_.diag-visage-op-title]:mb-2 [&_.diag-visage-op-title]:text-[15px]',
          '[&_.diag-visage-op-title_strong]:font-bold',
          className,
        )}
